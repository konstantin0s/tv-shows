        ...
        return (
            <div className="text-center one-person">
                ...
                <Card className="cardex">
                  <CardActionArea>
                    <CardContent className="image-card">
                      ...
                      <ReactFancyBox thumbnail={(!!person.image) ? person.image.medium : replaceNullImg} 
                      image={(!!person.image) ? person.image.medium : replaceNullImg}  />
                    ...
                    <CardContent>
                      <Typography gutterBottom variant="h5" component="h2">
                       Birthday: {" "} {Moment(person.birthtday).format('DD-MM-YYYY')}
                      </Typography>
                      <Typography variant="body2" color="textSecondary" component="p">
              ...
              Country: {" "}{(!!person.country) ? person.country.name : 'No country'}
                      ...
                      <Typography>
                      Status: {person.deathday === null ? 'Alive' : person.deathday}
                      </Typography>
                      <Typography variant="body2" color="textSecondary" component="p">
      <a href={person.url} target="_blank">  External details </a> 
                      </Typography>
                    </CardContent>
