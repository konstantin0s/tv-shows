                    ...
                    crew.slice(0,20).map((crewx) => (
                        ...
                        <CardActionArea>
                          <CardContent className="image-card">
                            ...
                            <ReactFancyBox thumbnail={(!!crewx.person.image) ? crewx.person.image.medium : replaceNullImg} 
                            image={(!!crewx.person.image) ? crewx.person.image.medium : replaceNullImg}  />
                          ...
                          <CardContent>
                            <Typography>
                             Gender: {" "} {crewx.person.gender}
                            </Typography>
                          </CardContent>
                          <CardContent>
                            <Typography variant="body2" color="textSecondary" component="p">
                    Country: {" "}{(!!crewx.person.country) ? crewx.person.country.name : 'No country'}
                            </Typography>
                            <Typography  variant="body2" component="p">
                             Birthday: {" "} {Moment(crewx.person.birthtday).format('DD-MM-YYYY')}
                            </Typography>
                            <Typography>
                            Status: {crewx.person.deathday === null ? 'Alive' : crewx.person.deathday}
                            </Typography>
                          </CardContent>
